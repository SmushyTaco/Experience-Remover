...
tasks {
    ...
    register<TaskPublishCurseForge>("publishCurseForge") {
        ...
        file.displayName = "[${project.extra["minecraft_version"] as String}] Experience Remover"
...
modrinth {
    ...
    projectId.set("experience-remover")
    uploadFile.set(tasks.remapJar)
    gameVersions.addAll(project.extra["minecraft_version"] as String)
    versionName.set("[${project.extra["minecraft_version"] as String}] Experience Remover")
    dependencies {
