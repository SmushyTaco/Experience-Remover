...
public abstract class RemoveEnchantmentTableFunctionality {
    ...
    private ActionResult hookOnUse(ActionResult original, BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) { return ExperienceRemover.INSTANCE.getConfig().getDisableMod() || ExperienceRemover.INSTANCE.getConfig().getAllowEnchantmentTableUse() || player.isCreative() ? original : ActionResult.FAIL; }
